...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_date_picker__ = __webpack_require__(158);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FilterModalPage = /** @class */ (function () {
    function FilterModalPage(navCtrl, navParams, viewCtrl, EventData) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.viewCtrl = viewCtrl;
        this.EventData = EventData;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__favorties_favorites__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__createEvent_createEvent__ = __webpack_require__(203);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__alerts_alerts__ = __webpack_require__(102);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SearchPage = /** @class */ (function () {
    function SearchPage(navCtrl, modalCtrl, EventData) {
        ...
        this.FilterList = this.EventData.FilterList;
    }
    ...
    SearchPage.prototype.openEventModal = function () {
        var eventModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_6__event_event__["a" /* EventPage */]);
        eventModal.present();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_date_picker__ = __webpack_require__(158);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_alerts_alerts__ = __webpack_require__(102);
...
var EventData = /** @class */ (function () {
    ...
    ;
    EventData.prototype.filter = function (type, food, diet, distance, date) {
        this.FilterList = [];
        this.TempList = [];
        for (var _i = 0, type_1 = type; _i < type_1.length; _i++) {
            ...
            for (var _a = 0, _b = this.EventList; _a < _b.length; _a++) {
                var event_1 = _b[_a];
                if (a == event_1.type || a == -1) {
                    this.FilterList.push(event_1);
                }
            }
        }
        for (var _c = 0, food_1 = food; _c < food_1.length; _c++) {
            var b = food_1[_c];
            for (var _d = 0, _e = this.FilterList; _d < _e.length; _d++) {
                var event_2 = _e[_d];
                if (b == event_2.food || b == -1) {
                    this.TempList.push(event_2);
                }
            }
        }
        for (var _f = 0, diet_1 = diet; _f < diet_1.length; _f++) {
            var c = diet_1[_f];
            for (var _g = 0, _h = this.FilterList; _g < _h.length; _g++) {
                var event_3 = _h[_g];
                if (c == event_3.type || c == -1) {
                    this.TempList.push(event_3);
                }
            }
        }
